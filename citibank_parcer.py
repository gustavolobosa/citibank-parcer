...
def parcear(ruta):
    ...
    for index, row in df.iterrows():
        ...
        rut = row["RUC/RUT/NIT"].replace(".", "").replace("-", "").replace(" ", "")
        ...
        if divisa == "CLP":
            ...
            cadena.append("3") #OK (primera vez deberia ser 2?)
...
ruta = "C:/Users/globos/OneDrive - Grenergy Renovables/Documentos/Isabel/citibank/remesas"
